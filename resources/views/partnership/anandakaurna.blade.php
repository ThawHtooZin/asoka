        ...
        <div class="min-h-screen">
            ...
            <header class="bg-white shadow pb-72 md:pb-36">
                <div class="relative">
                    ...
                    <div
                        class="absolute w-full bottom-[-17rem] md:bottom-[-9rem] left-1/2 transform -translate-x-1/2 md:left-10 md:translate-x-0 flex flex-col md:flex-row items-center md:items-start text-center md:text-left">
                        <!-- Profile Picture -->
