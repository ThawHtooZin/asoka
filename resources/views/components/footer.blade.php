<div class="bg-primary text-white px-6 py-6">
    <div class="grid grid-cols-5 text-center items-center border-b border-gray-500 pb-4">

        <!-- Left Column: Social Icons -->
        <div class="flex space-x-4 justify-center items-center col-span-2">
    ...
    <div class="flex justify-center items-center pt-4">
        <p class="text-xs text-gray-400">&copy; 2024 Asoka Center for Buddhist Studies. All rights reserved. Powered By
