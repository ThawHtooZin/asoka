                                ...
                                <form id="editBookForm" method="POST" action="/dashboard/books/{{ $book->id }}"
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="book_url" id="editBookUrl"
        ...
        <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="addBookForm" method="POST" action="/dashboard/books/store" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <div class="form-group">
                                <!-- Book Title -->
                                ...
                                <input type="text" class="form-control" name="book_url" id="editBookUrl" required>
                                @error('book')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
