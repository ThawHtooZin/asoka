...
class DashboardElibraryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'cover_image' => 'image|mimes:jpeg,png,jpg,gif|max:5048', // Image validation
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = $request->validate([
            ...
            'book_category_id' => 'required',
            'isbn' => 'required|string|max:17', // ISBN typically 10 or 13 characters
            'cover_image' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:5048', // Optional image validation
            'description' => 'required|string',
            'price' => 'required|numeric',
            'book_url' => 'required|string',
        ]);
