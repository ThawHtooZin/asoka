...
class DashboardResearchArticleController extends Controller
{
    public function index()
    {
        $articles = Article::get()->where('article_type', 'researcharticle');
        $categories = ArticleCategory::get();
        return view('dashboard.researcharticle', compact('articles', 'categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data['article_type'] = 'researcharticle'; // Map to the correct column name
        ...
        return redirect('/dashboard/researcharticles');
    }
